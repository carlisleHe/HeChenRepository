...
public class ArrayModNodeLocator implements NodeLocator {
	...
	private ArrayModNodeLocator(WechatNode[] n, HashAlgorithm alg) {
	    super();
	    nodes = n;
	    hashAlg = alg;
	  } 
	...
	@Override
	public WechatNode getPrimary(String k) {
	...
	public NodeLocator getReadonlyCopy() {
		WechatNode[] n = new WechatNode[nodes.length];
	...
	public void updateLocator(List<WechatNode> nodes) {
		 this.nodes = nodes.toArray(new WechatNode[nodes.size()]);
	...
	class ArrayModIterator implements Iterator<WechatNode> {
	...
	public WechatNode[] getNodes() {
		return nodes;
	}

	public void setNodes(WechatNode[] nodes) {
		this.nodes = nodes;
	}
