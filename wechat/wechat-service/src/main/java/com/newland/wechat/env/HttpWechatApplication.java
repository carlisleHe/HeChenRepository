...
public class HttpWechatApplication implements InitializingBean{
	

	private static Properties props;
	
	private static Properties getProps(){
		synchronized(HttpWechatApplication.class){
			if (props == null){
				InputStream in = HttpWechatApplication.class.getClassLoader().getResourceAsStream("runtime.properties");
	...
	public void afterPropertiesSet() throws Exception {
		System.err.println("wx_maxTotal=" + HttpWechatApplication.getWxMaxTotal());
		System.err.println("wx_maxPerRoute=" + HttpWechatApplication.getWxMaxPerRoute());
		System.err.println("wx_soTimeout=" + HttpWechatApplication.getWxSoTimeout());
		System.err.println("wx_connectionTimeout=" + HttpWechatApplication.getWxConnectionTimeout());
