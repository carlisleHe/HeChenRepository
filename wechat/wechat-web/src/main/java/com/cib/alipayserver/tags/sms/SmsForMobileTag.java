 ...
 * 针对移动端改写
 * @modify 何琛
 * @version  Ver 1.0 2016.02.03
 * @since    SmsForMobileTag Ver 1.0
 */
public class SmsForMobileTag extends AbstractUITag{
...
//	}
	...
	public Component getBean(ValueStack arg0, HttpServletRequest arg1,
		...
		return new SmsForMobile(arg0,arg1,arg2);
	}
	protected void populateParams(){
		super.populateParams();
		SmsForMobile p = (SmsForMobile)component;
		p.setId(id);
		p.setpClass(pClass);
