 ...
 * LICENSE INFORMATION
 */
package com.cib.alipayserver.tags.sms;
 ...
 * @author 黄博飞
 * @modify 何琛
 * @since SmsForMobile Ver 1.0
 * @modifydate 2016.01.29
 */
public class SmsForMobile extends UIBean {
...
//    }
    ...
    public SmsForMobile(ValueStack stack, HttpServletRequest request,
    ...
    protected void evaluateExtraParams() {
        ...
        if (inputClass != null) {
        	...
        	/**
        	 * css样式从smsCode修改为txtc txtbt
        	 */
//            addParameter("inputClass", "smscode");
            addParameter("inputClass", "txtc txtbt");
        }
        if (inputValue != null) {
...
//        addParameter("fromOut", fromOut);
        ...
        /**
         * 网银中使用spingsecrity验证后的NetbankUserDetails对象来保存相关数据
         * 在目前微信和支付宝服务窗中用session来保存
         */
//        if (fromOut) {
