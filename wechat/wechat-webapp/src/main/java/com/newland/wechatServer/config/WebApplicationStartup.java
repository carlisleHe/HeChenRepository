...
import com.newland.wechat.servlet.ProxySpringServlet;
...
public class WebApplicationStartup implements WebApplicationInitializer {
	...
	private static Logger logger = LoggerFactory
			.getLogger(WebApplicationStartup.class);
...
//		 servletContext.addFilter(arg0,arg1);
	...
	private void addServlet(ServletContext servletContext) {
		...
		AnnotationConfigWebApplicationContext webContext = createWebContext(
				SpringMvcConfig.class, ViewConfiguration.class);
...
//		dynamic.addMapping("*.html, *.ajax, *.css, *.js, *.gif, *.jpg, *.png");
		...
		Dynamic dynamic2 = servletContext.addServlet("weixinProxy",
				new ProxySpringServlet());
		dynamic2.addMapping("/weixinproxy/*");
