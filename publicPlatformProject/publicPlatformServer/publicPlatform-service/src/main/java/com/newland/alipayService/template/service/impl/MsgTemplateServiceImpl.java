package com.newland.alipayService.template.service.impl;
...
import com.newland.alipayService.template.model.ColumnDefine;
import com.newland.alipayService.template.model.MsgTemplate;
import com.newland.alipayService.template.model.TempConf;
import com.newland.alipayService.template.model.TempConfExt;
import com.newland.alipayService.template.model.Template;
import com.newland.alipayService.template.service.MsgTemplateService;
...
public class MsgTemplateServiceImpl implements MsgTemplateService {
	 ...
	 */
	private void loadTemplate() throws AppBizException,CloneNotSupportedException {
		if (templateMap == null) templateMap = new HashMap<String, Map<String, MsgTemplate>>();
		List<Template> list = this.templateDao.queryAll();
		if (CollectionUtils.isEmpty(list)) throw new AppBizException("","模板消息不存在");
