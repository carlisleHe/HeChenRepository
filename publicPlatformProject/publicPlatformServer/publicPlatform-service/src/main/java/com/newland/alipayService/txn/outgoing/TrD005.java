...
public class TrD005
		extends
		TxnOutgoingService<TrD005.TrD005Request, TrD005.TrD005Response> {

	public TrD005() {
		super(TrD005Request.class, TrD005Response.class);
	}

	@SuppressWarnings("serial")
	public static class TrD005Request extends TxnRequest {

		public TrD005Request() {
			super("D005");
		}
        /**
         * 交易头版本号
	...
	@SuppressWarnings("serial")
	public static class TrD005Response extends TxnResponse {
        ...
        * 交易明细
        */
		@TxnColumn (column = "SYMXX", contentClass=java.util.ArrayList.class, targetClass=TrSYMXXResponse.class )		
		public List<TrSYMXXResponse> SYMXXResponses;
		public static class TrSYMXXResponse extends TxnResponse {
	
			public TrSYMXXResponse(){
				super("D005");
			}
        /**
         * 收益归属日期
		...
		public static TrSYMXXResponse newTrSYMXXResponse(){
			return new TrSYMXXResponse();
		}
