...
public class TrD001
		extends
		TxnOutgoingService<TrD001.TrD001Request, TrD001.TrD001Response> {

	public TrD001() {
		super(TrD001Request.class, TrD001Response.class);
	}

	@SuppressWarnings("serial")
	public static class TrD001Request extends TxnRequest {

		public TrD001Request() {
			super("D001");
		}
        /**
         * 交易头版本号
	...
	@SuppressWarnings("serial")
	public static class TrD001Response extends TxnResponse {
         ...
         * Type: NUMBER_15_2
         */
		@TxnColumn (column = "YEBYE" )
		public java.math.BigDecimal yebye;		
        /**
         * 历史累计收益
         * Type: NUMBER_15_2
         */
