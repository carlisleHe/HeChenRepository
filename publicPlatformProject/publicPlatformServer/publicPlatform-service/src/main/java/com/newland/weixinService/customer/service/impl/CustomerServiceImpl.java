package com.newland.weixinService.customer.service.impl;
		...
		try{
			...
			if(queryAuthCustomer != null){
				...
				for(BindCard a : list){
					...
					//5、解绑通知授权
					List<AuthNotify> notifys = authNotifyService.findAuthNotifyByAcctNo(WeixinApplication.getOpenbankId(), a.getOpenId(), a.getAcctNo());
