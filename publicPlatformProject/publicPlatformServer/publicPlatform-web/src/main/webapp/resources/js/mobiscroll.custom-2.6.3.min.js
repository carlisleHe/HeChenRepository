(function(a) {
    function m(f, c) {
        ...
        n.show = function(c) {
            ...
            h += "</div>" + ("inline" != p.display ? '<div class="dwbc' + (p.button3 ? " dwbc-p": "") + '"><span class="dwbw dwb-s"><span class="dwb dwb-e" role="button" tabindex="0">' + p.setText + "</span></span>" +      (p.button3 ? " dwbc-p": "") + '<span class="dwbw dwb-l"><span class="dwb dwb-e" role="button" tabindex="0">' + "长期" + "</span></span>" +      (p.button3 ? '<span class="dwbw dwb-n"><span class="dwb dwb-e" role="button" tabindex="0">' + p.button3Text + "</span></span>": "") + '<span class="dwbw dwb-c"><span class="dwb dwb-e" role="button" tabindex="0">' + p.cancelText + "</span></span></div></div>": "") + "</div></div></div>";
            v = a(h);
            K();
            E("onMarkupReady", [v]);
            ...
            if ("inline" != p.display) {
                ...
                function() {
                    $("#test_default").val($(".dwv").html());
                    n.cancel();
                   // n.select()

                });
                n.tap(a(".dwb-l span", v),
                function() {//添加
                   // $(".dwrc td:eq(0) .dw-ul").css({"-webkit-transition": "all 0s ease-out", "transition": "all 0s ease-out", "-webkit-transform": "translate3d(0px, -323320px, 0px)"});
                   // $(".dwrc td:eq(1) .dw-ul").css({"-webkit-transition": "all 0s ease-out", "transition": "all 0s ease-out", "-webkit-transform": "translate3d(0px, -400px, 0px)"});
                  //  $(".dwrc td:eq(2) .dw-ul").css({"-webkit-transition": "all 0s ease-out", "transition": "all 0s ease-out", "-webkit-transform": "translate3d(0px, -1160px, 0px)"});
                  //  $(".dwv").html("99991231");//长期
                	$("#test_default").val('长期');
                    n.cancel();
                });
