...
function returnList(){
	var openId =<s:property value="#session.openId"/>;
	document.location.href="${ctx}/bankCardManager!bankCardList.do?openId="+openId;
}
</script>
</head>
<body>
	...
	<div class="btnbox">
	<input type="button" class="nxtbt" value="返回" onclick="returnList();" />
	</div>
