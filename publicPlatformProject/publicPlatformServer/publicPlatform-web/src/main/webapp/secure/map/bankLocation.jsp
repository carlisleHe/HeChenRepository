...
<body>
	...
	<script type="text/javascript">
		...
		//从参数里获取位置值
		var loc_name = '兴业银行<s:property value="name"/>';
		...
		function callback(xyResults){
			...
			var content = '<div style="width:180px;white-space:normal;margin:0;line-height:20px;padding:2px;">'
					+ '地址：' + loc_loc + '<br/>电话：<a href="tel://' + loc_tel + '" target="_blank">'+ loc_tel +'</a><br/><br/>' 
