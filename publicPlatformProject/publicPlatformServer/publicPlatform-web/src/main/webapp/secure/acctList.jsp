...
<body class="yhkbg">
	<ul class="wdyhk">
	 <s:iterator var="ac" value="#request.authCardViewList" status="st">
			<li>
				 <a href="authorization!show.do?selectIndex=<s:property value="#st.index"/>" onclick="" class="<s:if test="#ac.acctType==1">cxk</s:if><s:else>xyk</s:else>">
					<h3>兴业银行</h3>
		...
		<li class="tjyhk">
			<a href="authorization!index.do" class="yhklink">
