 ...
 */
@Entity
@Table(name="t_wechat_node")
public class WechatNode implements Serializable {
   ...
   public WechatNode(String nodeHost ){
    ...
    */
	...
	public boolean equals(Object obj) {
		if (obj instanceof WechatNode) {
			return ((WechatNode) obj).nodeHost.equals(this.nodeHost);
		}
