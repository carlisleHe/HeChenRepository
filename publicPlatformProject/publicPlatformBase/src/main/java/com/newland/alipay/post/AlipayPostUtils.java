...
import com.newland.alipay.post.model.Menu;
import com.newland.alipay.resp.Resp;
import com.newland.base.util.CompareUtil;
/**
 * 支付宝服务交互工具类
 * @author Shizn
 *
...
public class AlipayPostUtils {
	...
	public static String getOauthOpenId(String code) throws AppBizException{
		...
		try{
			...
			/**
			 * 2016.03.08
			 * alipay于2016.2.22更改了openID获取的字段
			 * 原来alipay_user_id更改为user_id
			 */
			String openId = resp.getString("user_id");
			return openId;
		}
		catch(Exception e){
			logger.error(e.getMessage(),e);
