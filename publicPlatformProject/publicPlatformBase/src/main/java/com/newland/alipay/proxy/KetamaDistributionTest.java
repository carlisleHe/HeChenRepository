...
public class KetamaDistributionTest {
	...
	public static void main(String[] args) {
		...
		Map<AlipayNode, Integer> nodeRecord = new HashMap<AlipayNode, Integer>();
		
		List<AlipayNode> allNodes = test.getNodes(NODE_COUNT);
		...
		for (String key : allKeys) {
			AlipayNode node = locator.getPrimary(key);
		...
		for (Map.Entry<AlipayNode, Integer> entry : nodeRecord.entrySet()) {
	 ...
	 * 		the node list
	 */
	private List<AlipayNode> getNodes(int nodeCount) {
