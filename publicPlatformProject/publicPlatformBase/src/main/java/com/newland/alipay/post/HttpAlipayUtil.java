package com.newland.alipay.post;
...
import com.newland.alipay.env.HttpAlipayApplication;
...
public class HttpAlipayUtil extends AbstractHttpUtil {
	
private static final Logger logger = LoggerFactory.getLogger(HttpAlipayUtil.class);
	...
	private static ThreadSafeClientConnManager cm  = null;
	 ...
	 static {
	       ...
	       //客户端总并行链接最大数 
	        cm.setMaxTotal(Integer.parseInt(HttpAlipayApplication.getWxMaxTotal()));
	       //每个主机的最大并行链接数 
	        cm.setDefaultMaxPerRoute(Integer.parseInt(HttpAlipayApplication.getWxMaxPerRoute()));
	  ...
	  public static DefaultHttpClient getPoolHttpClient() {
			   ...
			   //设置请求超时 时间
			    ...
			    params.setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, Integer.parseInt(HttpAlipayApplication.getWxConnectionTimeout()));  
			    params.setParameter(CoreConnectionPNames.SO_TIMEOUT, Integer.parseInt(HttpAlipayApplication.getWxSoTimeout())); 
